...
END;$$;-- Finds the easting of a provided Great Britain grid reference in datum units (m)
...
BEGIN
    ...
    RETURN letterConverted||numPad;
END;$$;-- Finds the northing of a provided Irish National Grid grid reference in datum units (m)
